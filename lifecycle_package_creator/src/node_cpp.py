...
def create_cpp(template_dir, template_name, node_name, namespace, publishers, subscribers):
...
if __name__ == "__main__":
    ...
    template_name = "node_cpp.template"
    subscribers = {
    ...
    create_cpp(template_dir, template_name, "CodeMaker",
